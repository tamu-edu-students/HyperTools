...
int main (int argc, char *argv[])
{
  ...
  else // if not taking images, then process images in a directory
  {
        ...
        // calibration files
        HyperFunctions1.dark_img = "../../HyperImages/CalibSnow/Dark_001.cu3s";
        HyperFunctions1.white_img = "../../HyperImages/CalibSnow/White_001.cu3s";
        // HyperFunctions1.dist_img = "../../HyperImages/CalibSnow/Distance_001.cu3s";
        HyperFunctions1.dist_val_mm=6000; // distance in mm

        // image directory 
        string image_directory = "../../HyperImages/export_snow/";

        string file_extension = ".cu3s";
        ...
        if (file_extension == ".cu3s")
        {
            ...
            proc.calc_distance(HyperFunctions1.dist_val_mm);
            cuvis::ProcessingArgs procArgs;
        
            // procArgs.processing_mode = cuvis::processing_mode_t::Cube_Reflectance;
            // procArgs.processing_mode = cuvis::processing_mode_t::Cube_SpectralRadiance;
            // procArgs.processing_mode = cuvis::processing_mode_t::Cube_DarkSubtract;
