...
int main (int argc, char *argv[])
{
  ...
  //do hypercuvis functions, else base functions
    ...
    // HyperFunctions1.factor_dir="../../HyperImages/cornfields/Calibration"; // requires init.daq file


    HyperFunctions1.cubert_img = "../../HyperImages/export/White_001.cu3s";
    HyperFunctions1.dark_img = "../../HyperImages/calib_intr/Dark_001.cu3s";
    HyperFunctions1.white_img = "../../HyperImages/calib_intr/White_001.cu3s";
    HyperFunctions1.cubert_settings="../settings/ultris5";  //camera settings file 
    HyperFunctions1.factory_dir="../settings/ultris5"; // 
  ...
  #else
    HyperFunctions HyperFunctions1; 
    // string file_name2="../../HyperImages/LIB-HSI/LIB-HSI/validation/reflectance_cubes/2020-11-27_021.dat";
