...
int main (int argc, char *argv[]) {
    ...
    // SAM -  Classification with Parent 
    start = high_resolution_clock::now();
    ...
    // SCM - Classification with Parent 
    start = high_resolution_clock::now();
    ...
    // SID - Classification with Parent 
    start = high_resolution_clock::now();
    ...
    // COS - Classification with Parent 
    start = high_resolution_clock::now();
    ...
    // City Block -  Classification with Parent 
    start = high_resolution_clock::now();
    ...
    // Euclidean -  Classification with Parent 
    start = high_resolution_clock::now();
