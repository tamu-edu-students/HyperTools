...
static void set_feature_detector_SSIFT(GtkWidget *widget,  gpointer data);
...
static void set_feature_descriptor_SsiftDescriptors(GtkWidget *widget,  gpointer data);
